'use strict';
// Bank of Namibia exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bon';
...
/** Latest rate for one pair, e.g. getRate('USD', 'NAD', { apiKey }). */
